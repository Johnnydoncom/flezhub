                        ...
                        <div class="mb-6 flex items-center space-x-5">
                          <span class="dark:bg-jacarta-700 dark:border-jacarta-600 border-jacarta-100 bg-light-base flex h-11 w-11 shrink-0 items-center justify-center rounded-full border">
                            ...
                            <div>
                                ...
                                <a href="tel:2349063204011" class="hover:text-accent dark:text-jacarta-300 text-sm">+234 (906) 320-4011</a>
                            </div>
                        </div>
                        <div class="mb-6 flex items-center space-x-5">
                          <span class="dark:bg-jacarta-700 dark:border-jacarta-600 border-jacarta-100 bg-light-base flex h-11 w-11 shrink-0 items-center justify-center rounded-full border">
                            ...
                            <div>
                                ...
                                <address class="dark:text-jacarta-300 text-sm not-italic">15, Yusuf Street, Oke IRA, Lagos Nigeria.</address>
                            </div>
                        </div>
