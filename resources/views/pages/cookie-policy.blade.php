            ...
            <div class="article-content mx-auto max-w-[48.125rem] space-y-4">
                ...
                <div class="pl-0 sm:pl-4">
                    <ul>
                        ...
                        <li><strong>Company:</strong> when this policy mentions “Company,” “we,” “us,” or “our,” it refers to Amaris Synergy Limited, 15, yusuf street, oke ira, ogba, Lagos. that is responsible for your information under this Cookie Policy.</li>
                ...
                <h2 class="text-3xl font-extrabold pt-8">Introduction</h2>
                <p>
                    This Cookie Policy explains how Amaris and its affiliates (collectively "Amaris", "we", "us", and "ours"), use cookies and similar technologies to recognize you when you visit our website, including without limitation https://amaris.ng/ and any related URLs, mobile or localized versions and related domains / sub-domains ("Websites"). It explains what these technologies are and why we use them, as well as the choices for how to control them.
                </p>

                <h2 class="text-3xl font-extrabold pt-8">What is a cookie?</h2>
                <p>
                    A cookie is a small text file that is stored on your computer or other internet connected device in order to identify your browser, provide analytics, remember information about you such as your language preference or login information. They're completely
                    safe and can't be used to run programs or deliver viruses to your device.
                </p>

                <h2 class="text-3xl font-extrabold pt-8">Why do we use cookies?</h2>
                ...
                <h2 class="text-3xl font-extrabold pt-8">What type of cookies does Amaris use?</h2>
                <p>
                ...
                <h2 class="text-3xl font-extrabold pt-8">Essential Cookies</h2>
                <p>
                ...
                <h2 class="text-3xl font-extrabold pt-8">Performance and Functionality Cookies</h2>
                <p>
                ...
                <h2 class="text-3xl font-extrabold pt-8">Marketing Cookies</h2>
                <p>
                ...
                <h2 class="text-3xl font-extrabold pt-8">Analytics and Customization Cookies</h2>
                <p>
                ...
                <h2 class="text-3xl font-extrabold pt-8">Social Media Cookies</h2>
                <p>
                    ...
                    platform to help track conversions from ads, optimize ads based on collected data, build targeted audiences for future ads, andremarket to qualified users who have already taken certain action on the platform.
                </p>

                <h2 class="text-3xl font-extrabold pt-8">How you can manage cookies?</h2>
                <p>
                ...
                <h2 class="text-3xl font-extrabold pt-8">Blocking and disabling cookies and similar technologies</h2>
                ...
                <h2 class="text-3xl font-extrabold pt-8">Changes To Our Cookie Policy</h2>
                <p>We may change our Service and policies, and we may need to make changes to this Cookie Policy so that they accurately
